...
import com.xkball.tin_tea_tech.api.shape.TTShapes;
...
public enum RelativeFacing {
    ...
    public static Shape2D getMusk(RelativeFacing facing){
        switch (facing){
            case left -> {
                return TTShapes.leftCross;
            }
            case right -> {
                return TTShapes.rightCross;
            }
            case up -> {
                return TTShapes.upCross;
            }
            case down -> {
                return TTShapes.downCross;
            }
            default -> {
                return TTShapes.crossMusk;
            }
        }
    }
}
