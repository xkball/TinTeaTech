...
public enum Connections {
    ...
    Connections(int index,int opposite, Vec3i relativePos,Slice slice,Direction... contains) {
        ...
        if(contains.length == 1){
            var d = contains[0];
            ConnectionsData.dConnections.put(d,Pair.of(this,d));
            ConnectionsData.cConnections.put(this,Pair.of(d,d));
        }
        else if(contains.length == 2){
            var d1 = contains[0];
            var d2 = contains[1];
            ConnectionsData.dConnections.put(d1,Pair.of(this,d2));
            ConnectionsData.dConnections.put(d2,Pair.of(this,d1));
            ConnectionsData.cConnections.put(this,Pair.of(d1,d2));
        }
    }
