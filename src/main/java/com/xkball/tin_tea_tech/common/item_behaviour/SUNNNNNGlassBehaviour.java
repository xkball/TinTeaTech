...
@I18N(chinese = "墨镜",english = "SUNNNNNGlass")
public class SUNNNNNGlassBehaviour implements IItemBehaviour, IHoloGlassPlugin {
    @Override
    public int mode() {
        return 6;
    }
    ...
    public void tooltip(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.tin_tea_tech.sunnn_glass").withStyle(ChatFormatting.GRAY));
    }
}
