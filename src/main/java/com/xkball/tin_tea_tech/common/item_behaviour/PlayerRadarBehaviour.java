...
@Model(resources = {"tin_tea_tech:item/player_radar"})
@I18N(chinese = "玩家雷达",english = "PlayerRadar")
public class PlayerRadarBehaviour implements IItemBehaviour, IHoloGlassPlugin {
